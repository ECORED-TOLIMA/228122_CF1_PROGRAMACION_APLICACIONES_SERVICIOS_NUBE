        ...
        .row.justify-content-center
          .col-lg-12(data-aos="fade-down")
            .row.d-flex.align-items-center.bg-05(data-aos="fade-right")
              ...
              .col-lg
                p Históricamente, en los primeros proyectos de desarrollo de software, especialmente entre las décadas de 1960 y 1970, era común que los equipos comenzaran a programar sin realizar una adecuada identificación de requisitos. Esta situación provocaba retrasos, sobrecostos y sistemas que no cumplían con las expectativas del cliente. A partir de estas experiencias surgieron metodologías y buenas prácticas orientadas a mejorar la captura y gestión de los requisitos.

                .row.align-items-start.mt-4
                  .col-lg-2.mb-lg-0.mb-4
                    figure(data-aos="fade-down")
                      img(src='@/assets/curso/tema5/16.svg', style='width: 100px').m-auto
                  
                  .col
                    p En la actualidad, la ingeniería de requisitos establece un conjunto de principios que orientan la forma en que debe realizarse la elicitación para obtener información clara, completa y verificable.

    p.mt-4.mb-4(data-aos="fade-down") Entre los principales principios y buenas prácticas se destacan los siguientes:
